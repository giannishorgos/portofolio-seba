...
const Projects = () => {
    ...
    const vroom_desc = "Team VROOM is based in the Department of Electrical and Computer Engineering of the Aristotle University of Thessaloniki in Greece. Is focused on developing autonomous driving solutions for scaled vehicles. Currently, we are participating -for the third time in a row- in the Bosch Future Mobility Challenge organized by the Bosch Engineering Center in Cluj Napoca, Romania.  Our five-member team focuses on developing innovative autonomous driving algorithms, with my role specifically centered around intersection and roundabout navigation. We aspire to extend our expertise beyond scaled vehicles and contribute to advancements in autonomous driving for full-scale vehicles."
    return (
